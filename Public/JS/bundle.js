...
if (ExtraInfo) {
  // console.log(user);
  ExtraInfo.addEventListener("submit", function (e) {
    e.preventDefault();
    console.log(e);
    var obj = {};
...
if (logins) {
  logins.addEventListener('submit', function (e) {
    ...
    // console.log(obj);
    (0, _functions.login)(obj.email, obj.password);
  });
}
if (signIn) {
