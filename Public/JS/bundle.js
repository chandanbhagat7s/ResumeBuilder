    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://127.0.0.1:3001/api/v1/user/login', {
            email: email,
            password: password
          });
        case 3:
          ...
          console.log(res);
          if (res.data.status) {
            (0, _alerts.showAlert)(res.data.status, "you are succesfully logged in !");
...
if (logins) {
  logins.addEventListener('submit', function (e) {
    ...
    (0, _functions.login)(email, password);
  });
}
if (signIn) {
  signIn.addEventListener('submit', function (e) {
    ...
    var name = document.getElementsByClassName('signup-name')[0].value;
    var email = document.getElementsByClassName('signup-email')[0].value;
    var mobile = document.getElementsByClassName('signup-number')[0].value;
    var password = document.getElementsByClassName('signup-password')[0].value;
    var cnfPassword = document.getElementsByClassName('signup-cnfPassword')[0].value;
